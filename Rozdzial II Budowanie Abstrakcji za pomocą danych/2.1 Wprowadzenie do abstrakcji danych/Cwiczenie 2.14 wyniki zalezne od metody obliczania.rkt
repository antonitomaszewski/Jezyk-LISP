...
(define p1 (make-interval 200 201))
(define p2 (make-interval 100 101))
(par1 p1 p2)
(par2 p1 p2)
(div-interval p1 p1)
(div-interval p1 p2)
...
;(percent p2)
#|
problem polega na tym, że nie mamy identyczności, czyli Id = A * (A^-1)
niech a = [1, 5]
b = [1, 5],
wtedy a/a powinno się równać Id, ale tak się nie stanie
|#
